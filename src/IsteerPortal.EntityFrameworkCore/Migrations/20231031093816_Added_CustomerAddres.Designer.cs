...
{
    [DbContext(typeof(IsteerPortalDbContext))]
    [Migration("20231031093816_Added_CustomerAddres")]
    partial class AddedCustomerAddres
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IsteerPortal.CustomerAddress.CustomerAddres", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppCustomerAddress", (string)null);
                });

            modelBuilder.Entity("IsteerPortal.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IsteerPortal.CustomerAddress.CustomerAddres", b =>
                {
                    b.HasOne("IsteerPortal.Customers.Customer", null)
                        .WithMany()
